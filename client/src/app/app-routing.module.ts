...
const routes: Routes = [
    ...
    {path: '', component: AllBlocksComponent, outlet: 'footer'},
    {path: 'home', component: HomeComponent},
    {path: 'home', component: AllBlocksComponent, outlet: 'footer'},
    {path: 'contact', component: ContactComponent},
    {path: 'contact', component: AllBlocksComponent, outlet: 'footer'},
